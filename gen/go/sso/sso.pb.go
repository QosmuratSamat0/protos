...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x04Auth\x129\n" +
	"\bRegister\x12\x15.auth.ReqisterRequest\x1a\x16.auth.RegisterResponse\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x14Z\x12samat.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_goTypes = []any{
	(*ReqisterRequest)(nil),  // 0: auth.ReqisterRequest
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.ReqisterRequest
